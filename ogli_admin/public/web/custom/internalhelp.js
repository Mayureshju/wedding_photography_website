...
function edit_internalhelp(id, search, page) {

    if (id != '')
        window.location.href = CI_ROOT + "Internalhelp/edit_internalhelp/" + id + "/" + search + "/" + page;
    else
...
$("#userid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Internalhelp/get_userdates',
        data: {
            userid: userid
        },
        success: function(result) {
...
$("#orderid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Internalhelp/get_orderdata',
        data: {
            orderid: orderid
        },
        success: function(result) {
