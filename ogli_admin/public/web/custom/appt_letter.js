...
function edit_appt_letter(id, search, page) {

    if (id != '')
        window.location.href = CI_ROOT + "Appointmentletter/edit_appt_letter/" + id + "/" + search + "/" + page;
    else
...
$("#userid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Appointmentletter/get_userdates',
        data: {
            userid: userid
        },
        success: function(result) {
...
$("#orderid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Appointmentletter/get_orderdata',
        data: {
            orderid: orderid
        },
        success: function(result) {
