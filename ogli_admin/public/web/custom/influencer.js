$(document).ready(function() {
    ...
    if (userid != '') {
        $.ajax({
            type: "POST",
            url: CI_ROOT + 'Influencer/get_userdates',
            data: {
                userid: userid
            },
...
function edit_influencer(id, search, page) {

    if (id != '')
        window.location.href = CI_ROOT + "Influencer/edit_influencer/" + id + "/" + search + "/" + page;
    else
...
$("#orderid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Influencer/get_orderdata',
        data: {
            orderid: orderid
        },
        success: function(result) {
