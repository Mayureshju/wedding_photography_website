$(document).ready(function() {
    ...
    if (userid != '') {
        $.ajax({
            type: "POST",
            url: CI_ROOT + 'Qualitycheck/get_userdates',
            data: {
                userid: userid
            },
...
function edit_qualitycheck(id, search, page) {

    if (id != '')
        window.location.href = CI_ROOT + "Qualitycheck/edit_qualitycheck/" + id + "/" + search + "/" + page;
    else
...
$("#orderid").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: CI_ROOT + 'Qualitycheck/get_orderdata',
        data: {
            orderid: orderid
        },
        success: function(result) {
