	...
	<section class="section">
        <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Influencer</li>
            </ol>
            </div>
							...
							<div class="e-table">
							    <div class="row">
                                    <div class="col-sm-12 col-md-2 col-xs-12 mb-3">
                                        <a href=""><h4 style="font-size: 1.1rem !important;">Manage Influencer</h4></a>
                                    </div>
                                    <div class="col-sm-12 col-md-8 col-xs-12">
                                        <form class="form-horizontal" id="mainform" action="<?php echo base_url();?>index.php/Nav/search_view_influencer" method="POST">
                                            <div class="row" id="bs-example-navbar-collapse-1">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    ...
                                                    <select class="form-control select2" name="filter" id="searchfilters" style="width:100%;">
                                                        <option value="Mflnc_id" <?php echo $filterval == 'Mflnc_id'?'selected':'';?>>Influencer ID</option>	
                                                        <option value="Mflnc_name" <?php echo $filterval == 'Mflnc_name'?'selected':'';?>>Influencer Name</option> 
                                                        <option value="MNC_cat_id" <?php echo $filterval == 'MNC_cat_id'?'selected':'';?> >Category</option>
                                                        <option value="Mprm_ID" <?php echo $filterval == 'Mprm_ID'?'selected':'';?> >Promocode</option>
                                                        <option value="Mflnc_Updated_Date" <?php echo $filterval == 'Mflnc_Updated_Date'?'selected':'';?>>Updated Date</option>
                                                        <option value="Mflnc_Created_Date" <?php echo $filterval == 'Mflnc_Created_Date'?'selected':'';?>>Created Date</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;" id="plainsearch">
                                                    ...
                                                    ?>
                                                    <input type="text" name="search" class="form-control" value="<?= $search_val?>">
                                                </div>

                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;" id="catname">
                                                    <select class="form-control select2" name="MNC_cat_id" style="width:100%;">                     
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;" id="procode">
                                                    <select class="form-control select2" name="Mprm_ID" style="width:100%;">                     
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    <select class="form-control select2" name="status" id="status" style="width:100%;">
                                                        <?php  if(isset($status)){  ?>
                                                            ...
                                                            <option <?php echo $status == 3?"selected":"";?> value="1">All Influencer</option>
                                                            <option <?php echo $status == 2?"selected":"";?> value="0">Inactive Influencer</option>					
                                                        <?php  }else {  ?>
                                                            <option value=''> Select </option>
                                                            <option selected value="1" >All Influencer</option>
                                                            <option  value="0">Inactive Influencer</option>
                                                        <?php }?>
                                                    </select>									
                                                </div>
                                    ...
                                    <?php if (in_array("Manage Influencer", $pagemodify)) { ?>
                                        <a href="<?php echo base_url();?>Influencer/add_influencer" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New">
                                        <i class="fa fa-plus"></i>
                                        </a>
                                    <?php } ?>
                                        <a href="<?php echo base_url();?>Nav/manage_influencer/<?php echo $no;?>" data-toggle="tooltip" title="Reset" class="btn btn-default" data-original-title="Rebuild">
                                ...
                                <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody> 
                                                <?php 									
                                                    if(isset($inflncr) && $inflncr !='no')
                                                    {
                                                        foreach($inflncr as $key=>$val)
                                                        {
                                                            ?>
                                                            <tr>
                                                                <td class="align-middle text-center"><?php echo $val->Mflnc_id; ?></td>
                                                                <td class="align-middle text-center"><?php echo $val->Mflnc_name; ?></td>
                                                                <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_lov', 'ML_LOV_Value', $val->MNC_cat_id, 'ML_ID'); ?></td>															
                                                                <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_promocode', 'Mprm_PromoCode', $val->Mprm_ID, 'Mprm_ID'); ?></td>
                                                                <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_user_master', 'MUM_Full_name', $val->Mflnc_UpdatedBy, 'MUM_ID'); ?></td>
                                                                <td class="text-center align-middle">
                                                                    <label class="custom-switch">
                                                                        <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input status <?php if($val->Mflnc_cat_status == 1){echo 'active_status';}else{echo 'Inactive';}?>" alt="<?php echo $val->Mflnc_cat_status;?>" <?php if($val->Mflnc_cat_status == 1) echo 'checked';?> >
                                                                ...
                                                                <td class="align-middle text-center"><button class="btn btn-sm btn-primary badge" style="cursor:pointer; " title='Edit Influencer' onclick="edit_influencer(<?php  echo $val->Mflnc_id.',\''.$searchstr.'\','.$page; ?>)"><i class="fa fa-edit"></i></button> </td>
...
echo my_file1('web/custom/influencer.js?v=211020.0',2);
?>
<script>
	 $(function () {
   $("#example1").DataTable();
...
<script>
    ...
    else if(searchfilters == 'Mprm_ID'){ 
        $("#catname").hide();   
        $("#procode").show();    
        $("#dateidd").hide();
        $("#plainsearch").hide()
    }
    else if(searchfilters == 'Mflnc_name'){ 
        $("#catname").hide();   
        $("#procode").hide();    
        $("#dateidd").hide();
        $("#plainsearch").show()
    }
    else if(filterval == 'Mflnc_id'){ 
        $("#catname").hide();   
        $("#procode").hide();    
        $("#dateidd").hide();
        $("#plainsearch").show()
    }
    else if(filterval == 'Mflnc_Updated_Date' || filterval == 'Mflnc_Created_Date'){     
        $("#catname").hide();   
        $("#procode").hide();    
        $("#dateidd").show();
        $("#plainsearch").hide()
    ...
    $("#searchfilters").change(function(){
        ...
        else if(searchfilters == 'Mflnc_id'){ 
            $("#catname").hide();   
            $("#procode").hide();    
            $("#dateidd").hide();
            $("#plainsearch").show()
        ...
        else if(searchfilters == 'Mflnc_Updated_Date' || searchfilters == 'Mflnc_Created_Date'){     
            $("#catname").hide();   
            $("#procode").hide();    
            $("#dateidd").show();
            $("#plainsearch").hide()
