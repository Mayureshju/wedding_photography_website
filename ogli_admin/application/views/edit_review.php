								...
								<div class="row">
									<div class="col-12">
										<form action="<?php echo base_url()?>index.php/Review/edit_review_data" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
											<input type="hidden" name="editid" id="editid" value="<?php echo $val->MRV_revid;?>">
											...
											<div class="row">
												<div class="col-6">
													...
													<!-- <div class="form-group mb-0 overflow-hidden mt-3">
														...
														<input name="MRV_review_title" value="<?= $val->MRV_review_title; ?>" class="form-control" type="text">                             
													</div> -->
													<div class="form-group mb-0 overflow-hidden mt-3">
														<label for="MRV_review">Review</label>    
														<textarea name="MRV_review" rows="4" cols="5" class="form-control" type="text"><?= $val->MRV_review; ?></textarea>                            
													</div>
													<div class="form-group mb-0 overflow-hidden mt-3">
														<label for="MRV_name">Your Name</label>    
														<input name="MRV_name" value="<?= $val->MRV_name; ?>"  class="form-control" type="text">                             
													</div>
												</div>
												<div class="col-6">
													...
													<div class="form-group mb-0 overflow-hidden mt-5">
														...
														<input name="MRV_email" value="<?= $val->MRV_email; ?>"  class="form-control" type="text">                             
													</div>
													<div class="form-group mb-0 overflow-hidden mt-3">
														<label for="MRV_phone">Mobile No</label>    
														<input name="MRV_phone" value="<?= $val->MRV_phone; ?>" class="form-control" type="text">                             
													</div>
													<div class="form-group mb-0 overflow-hidden mt-4">
														...
														<label class="custom-switch" style="margin-left: 20px;">
															<input type="checkbox" Value="1" name="MRV_status" id="status" class="custom-switch-input" <?php echo ($val->MRV_status =='1')?'checked':'' ?>>
