	...
	<section class="section">
        <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Internal Help</li>
            </ol>
            </div>
							...
							<div class="e-table">
							    <div class="row">
                                    <div class="col-sm-12 col-md-2 col-xs-12 mb-3">
                                        <a href=""><h4 style="font-size: 1.1rem !important;">Manage Internal Help</h4></a>
                                    </div>
                                    <div class="col-sm-12 col-md-8 col-xs-12">
                                        <form class="form-horizontal" id="mainform" action="<?php echo base_url();?>index.php/Nav/search_view_internalhelp" method="POST">
                                            <div class="row" id="bs-example-navbar-collapse-1">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    ...
                                                    <select class="form-control select2" name="filter" id="searchfilters" style="width:100%;">
                                                        <option value="MIh_id" <?php echo $filterval == 'MIh_id'?'selected':'';?>>Internalhelp ID</option>	
                                                        <option value="MIh_title" <?php echo $filterval == 'MIh_title'?'selected':'';?> >Question</option>
                                                        <option value="MIh_answer" <?php echo $filterval == 'MIh_answer'?'selected':'';?> >Answer</option>
                                                        <option value="MIh_UpdatedDate" <?php echo $filterval == 'MIh_UpdatedDate'?'selected':'';?>>Updated Date</option>
                                                        <option value="MIh_CreatedDate" <?php echo $filterval == 'MIh_CreatedDate'?'selected':'';?>>Created Date</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    <select class="form-control select2" name="status" id="status" style="width:100%;">
                                                        <?php  if(isset($status)){  ?>
                                                            ...
                                                            <option <?php echo $status == 3?"selected":"";?> value="1">All Internalhelp</option>
                                                            <option <?php echo $status == 2?"selected":"";?> value="0">Inactive Internalhelp</option>					
                                                        <?php  }else {  ?>
                                                            <option value=''> Select </option>
                                                            <option selected value="1" >All Internalhelp</option>
                                                            <option  value="0">Inactive Internalhelp</option>
                                                        <?php }?>
                                                    </select>									
                                                </div>
                                    ...
                                    <?php if (in_array("Manage Internalhelp", $pagemodify)) { ?>
                                        <a href="<?php echo base_url();?>Internalhelp/add_internalhelp" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New">
                                        <i class="fa fa-plus"></i>
                                        </a>
                                    <?php } ?>
                                        <a href="<?php echo base_url();?>Nav/manage_internalhelp/<?php echo $no;?>" data-toggle="tooltip" title="Reset" class="btn btn-default" data-original-title="Rebuild">
                                ...
                                <table id="example1" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="text-center">Internalhelp ID</th>
                                        ...
                                        <tbody> 
                                                <?php 		
                                                 		    if(isset($internalhelps) && $internalhelps !='no')
                                                    {
                                                      
                                                            foreach($internalhelps as $key=>$val)
                                                            {
                                                                ?>
                                                                <tr>
                                                                    <td class="align-middle text-center"><?php echo $val->MIh_id; ?></td>
                                                                    <td class="align-middle text-center"><?php echo $val->MIh_title; ?></td>
                                                                    <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_internalhelp', 'MIh_answer', $val->MIh_id, 'MIh_id'); ?></td>															
                                                                    <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_user_master', 'MUM_Full_name', $val->MIh_UpdatedBY, 'MUM_ID'); ?></td>
                                                                    
                                                                    <td class="text-center align-middle">
                                                                        <label class="custom-switch">
                                                                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input status <?php if($val->MIh_status == 1){echo 'active_status';}else{echo 'Inactive';}?>" alt="<?php echo $val->MIh_id;?>" <?php if($val->MIh_status == 1) echo 'checked';?> >
                                                                    ...
                                                                    <td class="align-middle text-center"><button class="btn btn-sm btn-primary badge" style="cursor:pointer; " title='Edit Internalhelp' onclick="edit_internalhelp(<?php  echo $val->MIh_id.',\''.$searchstr.'\','.$page; ?>)"><i class="fa fa-edit"></i></button> </td>
...
echo my_file1('web/custom/internalhelp.js?v=211020.0',2);
?>
<script>
	 $(function () {
   $("#example1").DataTable();
...
else if(filterval == 'MIh_CreatedDate' || filterval == 'MIh_UpdatedDate'){
...
else if(searchfilters == 'MIh_CreatedDate' || searchfilters == 'MIh_UpdatedDate'){
    $("#assignto").hide();	 
$("#client").hide();		
$("#dateidd").show();
$("#plainsearch").hide();
