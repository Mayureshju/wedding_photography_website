	...
	<div class="row">
		...
		<div class="section-body ">
			...
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-sm-12 col-md-2 col-xs-12 mb-3">
									<a href=""><h4 style="font-size: 1.1rem !important;">Manage Appointment</h4></a>
								</div>
								<div class="col-sm-12 col-md-8 col-xs-12">

					<form class="form-horizontal" id="mainform" action="<?php echo base_url();?>index.php/Nav/search_appointment_master" method="POST">
					<div class="row" id="bs-example-navbar-collapse-1">
						...
						<select class="form-control select2" name="status" id="status" style="width:100%;">
							...
							<option  value="3">All Appointment</option>
							<?php }?>
							</select>									
						</div>
				...
				<div class="no-shadow bg-transparent no-border rm-borders mb-3">
						<div class="card">
								<div class="no-gutters row" style="display: flex;flex-wrap: wrap;">
                                    <div class="col-md-12 col-lg-4 col-xs-12">
                                        <ul class="list-group list-group-flush">
                                            <li class="bg-transparent list-group-item">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-outer brodersep">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading">Total Tasks</div>
                                                                <div class="widget-subheading">(Till date)</div>
                                                            </div>
                                                            <div class="widget-content-right">
                                                                <div class="widget-numbers text-success"><?php echo $totaltaskdts; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="bg-transparent list-group-item">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-outer brodersep">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading">New Tasks</div>
                                                                <div class="widget-subheading">(This Week)</div>
                                                            </div>
                                                            <div class="widget-content-right">
                                                                <div class="widget-numbers text-danger"><?php echo $totalnewtaskd; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-outer">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right">
                                                                <div class="widget-numbers text-success"><?php echo $totalcompltaskd; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php if(isset($appointmentdtsfollowup) && $appointmentdtsfollowup !='no' && !empty($appointmentdtsfollowup))
      { ?>
<div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="card-header-tab card-header">
                                        <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                            <!-- <i class="header-icon lnr-lighter icon-gradient bg-amy-crisp"> -->
                                                <img src="<?php echo base_url(); ?>public/img/checklist.png" style="width:30px;">
                                            <!-- </i> -->
                                            Todays followup Task
                                        </div>
                                    ...
                                    <div class="scroll-area-lg">
                                        <div class="scrollbar-container ps ps--active-y">
                                            <div class="p-4">
                                                ...
                                                <?php 									
											if(isset($appointmentdtsfollowup) && $appointmentdtsfollowup !='no')
											{
													foreach($appointmentdtsfollowup as $key=>$val)
													{
                                                    ...
                                                    <div class="vertical-timeline-item <?php echo $dot; ?> vertical-timeline-element" >
                                                        <div>
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title" style="cursor:pointer; " onclick="edit_appointment(<?php  echo $val->MA_id.',\''.$searchstr.'\','.$page; ?>)"><?php echo $val->MA_name; ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- <a  class="editrow" style="cursor:pointer; " title='Edit pack detail'>
														<li onclick="edit_task(<?php  //echo $val->MT_ts_id.',\''.$searchstr.'\','.$page; ?>)"><?php //echo '<span style="color:#1021ea;">'.$val->MT_ts_name.'</span>'; ?></li>
														</a> -->
										<?php   
													}
											}
                                        ...
                                        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; "></div></div></div>
                                    </div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="card">
							...
							<ul class="list-group list-group-flush">
                                            <?php 									
												if(isset($appointmentdtstodays) && $appointmentdtstodays !='no' && !empty($appointmentdtstodays))
												{
														foreach($appointmentdtstodays as $key=>$val)
														{
															?>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading"><?php echo convert_commas_to_value('mov_clients', 'MC_cl_name', $val->MC_cl_id, 'MC_cl_id'); ?>
                                                                <span class="widget-content-right" style="float:right;">
                                                                <?php 																
																	echo '<span style="color:green;">'.$val->MA_start_datetime.'</span>';																	
																	?>
                                                                </span>
                                                            </div>
                                                                <div class="widget-subheading opacity-10">
                                                                    <span class="pr-2"><?php echo $val->MA_name; ?></span>                                                                   
                                                                </div>
                                                                <?php if($sess_role == '1'){?>
                                                                    <div class="widget-heading">
                                                                        <span class="widget-content-right" style="float:right;color: #da3f04;">
                                                                        <?php 
																			echo '<span>'.convert_commas_to_value('mov_user_master', 'MUM_Full_name', $val->MA_assignto, 'MUM_ID').'</span>';             
																		?>
                                                                        </span>
                                                                    </div>
                                                            <?php  } ?>
                                                            ...
                                                            <div class="widget-content-right">
                                                                <div class="icon-wrapper m-0">
                                                                    <div class="progress-circle-wrapper">
                                                                        <div class="circle-progress d-inline-block circle-progress-primary"><canvas width="52" height="52"></canvas>
                                                                            <small><span>
                                                                                <button class="btn-icon btn-icon-only btn btn-success btn-sm" title='Edit Task' onclick="edit_appointment(<?php  echo $val->MA_id.',\''.$searchstr.'\','.$page; ?>)">
									...
									?>
									<li colspan="13" class="list-group-item"><p class="text-center">No Record Found</p></li>
									<?php
								} 
								?>
                                            </ul>
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="card">
							<div class="card-header">
								<h4>This Week Appointment</h4>
							</div>
							<div class="card-body" style="padding: 5px !important;">
							<ul class="list-group list-group-flush">
                                            <?php 									
												if(isset($appointmentdtsthisweek) && $appointmentdtsthisweek !='no' && !empty($appointmentdtsthisweek))
												{
														foreach($appointmentdtsthisweek as $key=>$val)
														{
															?>
                                            <li class="list-group-item">
                                                    <div class="widget-content p-0">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="card">
							<div class="card-header">
								<h4>Next Week Appointment</h4>
							</div>
							<div class="card-body" style="padding: 5px !important;">
							<ul class="list-group list-group-flush">
                                            <?php 									
												if(isset($appointmentdtsnextweek) && $appointmentdtsnextweek !='no' && !empty($appointmentdtsnextweek))
												{
														foreach($appointmentdtsnextweek as $key=>$val)
														{
															?>
                                            <li class="list-group-item">
                                                    <div class="widget-content p-0">
...
echo my_file1('web/custom/appointment.js?v=021120.0',2);
?>
<script>
	 $(function () {
   $("#example1").DataTable();
