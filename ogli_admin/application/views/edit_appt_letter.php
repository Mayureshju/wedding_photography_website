			...
			<div class="card overflow-hidden">
				<div class="card-body">
					...
					// echo "<pre>"; print_r($editfaq); 
						if(isset($edit_appt_letter))
						{ 
							foreach($edit_appt_letter as $key => $val)
							{
								?>
								<div class="row">
									<div class="col-6">
										<form action="<?php echo base_url()?>index.php/Appointmentletter/edit_appt_letter_data" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
											<input type="hidden" name="editid" id="editid" value="<?php echo $val->Ml_id;?>">
											...
											<div class="form-group mb-0 overflow-hidden mt-3">
												...
												<input name="Ml_name" value="<?= $val->Ml_name; ?>" class="form-control" type="text">                             
											</div>
											<div class="form-group mb-0 overflow-hidden mt-3">
												<label for="metakeyword">Joining Date</label>
												<input class="form-control" value="<?= $val->Ml_joining_date; ?>" id="joining_date" name="Ml_joining_date"></textarea>
											</div>
											<div class="form-group mb-0 overflow-hidden mt-3">
												<label for="metakeyword">Letter Description</label>
												<textarea class="form-control inputheight" rows="5" name="Ml_description"><?= $val->Ml_description; ?></textarea>
											</div>
											<div class="form-group mb-0 overflow-hidden mt-3">
												<label for="metakeyword">Salary</label>
												<input class="form-control" type="number" value="<?= $val->Ml_salary; ?>" name="Ml_salary">
											</div>
											<div class="form-group mb-0 overflow-hidden mt-4">
												...
												<input type="checkbox" Value="1" name="Ml_status" id="status" class="custom-switch-input" <?php if(!empty($val->Ml_status)){ echo ($val->Ml_status =='1')?'checked':''; } ?> >
