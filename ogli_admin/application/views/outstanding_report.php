						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-sm-12 col-md-2 col-xs-12 mb-3">
									<a href=""><h4 style="font-size: 1.1rem !important;">Outstanding Report</h4></a>
								</div>
								<div class="col-sm-12 col-md-8 col-xs-12">
                  
						                               
								<?=form_open('Nav/search_outstanding_report',['class'=>'form-inline'])?>
										...
										if(isset($listofallorders)){
											foreach($listofallorders as $listall){
													// $per_Web_sales[$listall->FWCM_ID] += (float)$listall->MOR_total_amount;
													 ...
													 $totaloutstandingamt += $listall->MOR_total_amount - $listall->MOR_pay_amount;
									...
									<div class="table-responsive table-lg" style="margin-top: 10px;">
										...
										<th colspan="5" style="text-align:center;" bgcolor="#efefef">Sales Report</th>
											...
											<tr>
												...
												<td id="totalsale"><?php 
												 $totalusdamt = convert_currency('INR','USD',$totaloutstandingamt);
												 $totalsale = '<strong><p class="text-danger">Rs. '.moneyFormatIndia(round($totaloutstandingamt)).'
										...
										if(isset($listoforders)){
											...
											foreach($listoforders as $list){
												...
												?>
													...
													<td><?php echo moneyFormatIndia(round($list->MOR_pay_amount));?></td>
													<td><?php echo moneyFormatIndia(round($list->MOR_total_amount - $list->MOR_pay_amount));?></td>
