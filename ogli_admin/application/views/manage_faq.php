							...
							<div class="e-table">
							    <div class="row">
                                    <div class="col-sm-12 col-md-2 col-xs-12 mb-3">
                                        <a href=""><h4 style="font-size: 1.1rem !important;">Manage FAQ</h4></a>
                                    </div>
                                    <div class="col-sm-12 col-md-8 col-xs-12">
                                        <form class="form-horizontal" id="mainform" action="<?php echo base_url();?>index.php/Nav/search_view_faq" method="POST">
                                            <div class="row" id="bs-example-navbar-collapse-1">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    ...
                                                    <select class="form-control select2" name="filter" id="searchfilters" style="width:100%;">
                                                        <option value="MQa_id" <?php echo $filterval == 'MQa_id'?'selected':'';?>>FAQ ID</option>	
                                                        <option value="MM_ID" <?php echo $filterval == 'MM_ID'?'selected':'';?>>Page</option> 
                                                        <option value="MQa_title" <?php echo $filterval == 'MQa_title'?'selected':'';?> >Question</option>
                                                        <option value="MQa_answer" <?php echo $filterval == 'MQa_answer'?'selected':'';?> >Answer</option>
                                                        <option value="MQa_UpdatedDate" <?php echo $filterval == 'MQa_UpdatedDate'?'selected':'';?>>Updated Date</option>
                                                        <option value="MQa_CreatedDate" <?php echo $filterval == 'MQa_CreatedDate'?'selected':'';?>>Created Date</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-right:5px;">
                                                    <select class="form-control select2" name="status" id="status" style="width:100%;">
                                                        <?php  if(isset($status)){  ?>
                                                            ...
                                                            <option <?php echo $status == 3?"selected":"";?> value="1">All FAQ</option>
                                                            <option <?php echo $status == 2?"selected":"";?> value="0">Inactive FAQ</option>					
                                                        <?php  }else {  ?>
                                                            <option value=''> Select </option>
                                                            <option selected value="1" >All FAQ</option>
                                                            <option  value="0">Inactive FAQ</option>
                                                        <?php }?>
                                                    </select>									
                                                </div>
                                    ...
                                    <?php if (in_array("Manage FAQ", $pagemodify)) { ?>
                                        <a href="<?php echo base_url();?>Faq/add_faq" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New">
                                        <i class="fa fa-plus"></i>
                                        </a>
                                    <?php } ?>
                                        <a href="<?php echo base_url();?>Nav/manage_faq/<?php echo $no;?>" data-toggle="tooltip" title="Reset" class="btn btn-default" data-original-title="Rebuild">
                                ...
                                <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody> 
                                                <?php 									
                                                    if(isset($faqs) && $faqs !='no')
                                                    {
                                                            foreach($faqs as $key=>$val)
                                                            {
                                                                ?>
                                                                <tr>
                                                                    <td class="align-middle text-center"><?php echo $val->MQa_id; ?></td>
                                                                    <td class="align-middle text-center">
                                                                    <?php
                                                                    $parentmenulist = get_list('mov_menu','MM_Name',"MM_Status = 1  and MM_ID = $val->MM_ID");
                                                                    ?>
                                                                    <?php echo $parentmenulist[0]->MM_Name; ?>
                                                                    </td>
                                                                    <td class="align-middle text-center"><?php echo $val->MQa_title; ?></td>
                                                                    <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_qa', 'MQa_answer', $val->MQa_id, 'MQa_id'); ?></td>															
                                                                    <td class="align-middle text-center"><?php echo convert_commas_to_value('mov_user_master', 'MUM_Full_name', $val->MQa_UpdatedBY, 'MUM_ID'); ?></td>
                                                                    
                                                                    <td class="text-center align-middle">
                                                                        <label class="custom-switch">
                                                                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input status <?php if($val->MQa_status == 1){echo 'active_status';}else{echo 'Inactive';}?>" alt="<?php echo $val->MQa_id;?>" <?php if($val->MQa_status == 1) echo 'checked';?> >
                                                                    ...
                                                                    <td class="align-middle text-center"><button class="btn btn-sm btn-primary badge" style="cursor:pointer; " title='Edit FAQ' onclick="edit_faq(<?php  echo $val->MQa_id.',\''.$searchstr.'\','.$page; ?>)"><i class="fa fa-edit"></i></button> </td>
...
echo my_file1('web/custom/faq.js?v=211020.0',2);
?>
<script>
	 $(function () {
   $("#example1").DataTable();
