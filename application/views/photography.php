...
<head>
    <meta charset="UTF-8">
    <title>Residential Interior Designers in Pune | Home Interior Designer in Pune</title>

    <!-- responsive meta -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Residential interior design plays an indisputable role in ensuring just the right mix of luxury and comfort. Learn from boss of Residential Interior design" />
    <!-- For IE -->
...
<body>
    <div class="boxed_wrapper">
        ...
        <!--End Main Header-->
         ...
         <section class="breadcrumb-area style2" style="background-position: center;background-image: url('<?php if(!empty($data[0]->Mpg_bnr_residential_banner)){ echo base_url(); ?>ogli_admin/uploads/pagesbanner/<?= $data[0]->Mpg_bnr_residential_banner;  } ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5">
                        <div class="about-image-box">
                            <div class="inner-box">
                                <img src="<?php if(!empty($data[0]->Mpg_bnr_residential_side_image)){ echo base_url(); ?>ogli_admin/uploads/pagesbanner/<?= $data[0]->Mpg_bnr_residential_side_image; } ?>" alt="Awesome Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-7">
                        <div class="about-text">
                            <div class="sec-title">
                                <h2 class="title">Budget Friendly, And Awesome!</h2>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                            </div>
                            <div class="inner-content">
                                <div class="text">
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, quaerat fuga deleniti ab repudiandae, fugiat consectetur eos necessitatibus non delectus voluptatum iusto.</p>
                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, delectus! Quaerat, illum!.</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae iure et molestiae, illum eius a.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="main-project-area style2">
            <div class="sec-title text-center">
                <div class="title">Our Photography Projects</div>
            </div>
            <div class="container">
                    ...
                    <?php foreach ($all_residential as $value) { ?>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                            <div class="single-project-style5">
                                    ...
                                    where MP_Id = '$value->MP_Id'";
                                       ...
                                       <?php } ?>
                                        ...
                                        <div class="overlay-box">
                                            <div class="box">
                                                <div class="link">
                                                    <a href="photography-details/<?= $value->purl; ?>"><span class="icon-out"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="title">
                                    <h3><a href="residential-interior/<?= $value->purl; ?>"><?= $value->MP_Name; ?></a></h3>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                        ...
                        <div class="single-footer-widget marbtm50">
                            <div class="contact-info-box">
                                <div class="footer-logo" style="padding-bottom: 14px;">
                                    <a href="<?= base_url(); ?>">
                                        <img src="<?= base_url(); ?>assets/images/resources/newslog.jpg" alt=" Logo" style="width: 32%;">
                                    </a>
                                </div>
                                <ul>
                                    <li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="footer-bottom-content flex-box-two">
                            <div class="copyright-text">
                                <p style="color:#eae6e6;">© <?php echo date('Y'); ?> <a href="#" style="color:#eae6e6;">Photography</a>. All Rights Reserved. Developed by <a href="http://webswizards.in/" style="color:#eae6e6;">Webswizards</a></p>
                            </div>
