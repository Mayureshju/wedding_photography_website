...
<head>
    <meta charset="UTF-8">
    <title>Commercial Interior Designers in Pune | Office Interior Designers in Pune</title>

    <!-- responsive meta -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Creating a better working environment for your people and business is our key motto with commercial Interior design. We deliver innovative and inspiring office interior design, studio interior, and showroom interior design." />
    <!-- For IE -->
...
<body>
    <div class="boxed_wrapper">
                                    ...
                                    <nav class="main-menu clearfix">
                                        ...
                                        <div class="navbar-collapse collapse clearfix">
                                            ...
                                            <li><a href="<?= base_url(); ?>">Home</a></li>
                                                ...
                                                <li><a href="<?= base_url(); ?>residential-interior">Photography</a></li>
        ...
        <!--End Main Header-->
            ...
            <section class="breadcrumb-area style2" style="background-position: center;background-image: url('<?php if(!empty($data[0]->Mpg_bnr_commercial_banner)){ echo base_url(); ?>ogli_admin/uploads/pagesbanner/<?= $data[0]->Mpg_bnr_commercial_banner;  } ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-5">
                        <div class="about-image-box" style="margin-top: 2rem;">
                            <div class="inner-box">
                                <img src="<?php if(!empty($data[0]->Mpg_bnr_commercial_side_image)){ echo base_url(); ?>ogli_admin/uploads/pagesbanner/<?= $data[0]->Mpg_bnr_commercial_side_image;   } ?>" alt="Awesome Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-7">
                        <div class="about-text">
                            <!-- <div class="sec-title">
                                <div class="title">PROJECT IS A DREAM, WE MAKE IT A REALITY</div>
                                <p>We Always Deliver More Than Expected</p>
                            </div> -->
                            <div class="inner-content">
                                <div class="text">
                                    <p>Creating a better working environment for your people and business is our key motto with commercial Interior design. We deliver innovative and inspiring office interior design, studio interior, and showroom interior design. At Ogling Inches being the most reliable interior designers in Pune, we provide flexible interior design solutions which innovate the workplace and encourage employee’s engagement driving talent, greater connectivity and productivity.</p>

                                    <p>Ogling Inches operates as an integrated design Architect, bringing you everything that you may desire with regards to the creation of your ambiances whether Residential, Commercial, Healthcare or Hospitality.</p>

                                    <p>With probable technological and knowledge updates, we make sure to implement the most potential ideas.</p>

                                    <p>Collaborating with us would certainly let you watch over some of the best Architecture.</p>
                                </div>
                            </div>
                        </div>
                    </div>
       ...
       <section class="main-project-area style2">
            <div class="sec-title text-center">
                <h2 class="title">Our Commercial Projects</h2>
            </div>
            <div class="container">
                <div class="row filter-layout masonary-layout">
                    <!--Start single project item-->
                    <?php foreach ($all_commercial as $value) { ?>
                            ...
                            <div class="single-project-style5">
                                <div class="img-holder">
                                    <div class="inner">
                                        ...
                                        $sql1 = "SELECT MPI_Images, MP_Id
                                    FROM mov_portfolio_images
                                    where MP_Id = '$value->MP_Id'";
                                        ...
                                        <?php if($i == '1'){ ?>
                                                    <img src="<?php //echo base_url(); 
                                                        ?>ogli_admin/uploads/portfolio-images/<?php echo $valuemg->MPI_Images; ?>" alt="Awesome Image">
                                       <?php } ?>
                                        ...
                                        <div class="overlay-box">
                                            <div class="box">
                                                <div class="link">
                                                    <a href="commercial-interior/<?= $value->purl; ?>"><span class="icon-out"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="title">
                                    <h3><a href="commercial-interior/<?= $value->purl; ?>"><?= $value->MP_Name; ?></a></h3>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
        ...
        <section class="working-process-area">
            <div class="container">
                <div class="sec-title text-center">
                    <div class="title">Our Commercial Design Process</div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="single-working-process text-center">
                            ...
                            <div class="inner" style="height: 17rem;">
                                <h3>Meet And Greet</h3>
                                <p>We Introduce our self and Note Down your requirements</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="single-working-process text-center">
                            ...
                            <div class="inner" style="height: 17rem;">
                                <h3>Schemetic Design</h3>
                                <p>We Present you the idea and concept</p>
                            </div>
                        </div>
                    </div>
                    <!--End Single Working Process-->
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                        <div class="single-working-process text-center">
                            ...
                            <div class="inner" style="height: 17rem;">
                                <h3>Estimate and Detailing</h3>
                                <p>We develop the detailed design and for finance management of the project</p>
                            </div>
                        </div>
                    </div>
                    <!--Start Single Working Process-->
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                        <div class="single-working-process text-center">
                            ...
                            <div class="inner" style="height: 17rem;">
                                ...
                                <p>We supervise the project and handover with documents and Certificates.</p>
                            </div>
                        </div>
                    </div>
                    <!--End Single Working Process-->
                        ...
                        <div class="testimonial-carousel-2 owl-carousel owl-theme">
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="<?= base_url(); ?>assets/images/testimonial/Ram-Subbarao.jpg" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                            <h3>Ram Subbarao</h3>
                                        </div>
                                    ...
                                    <div class="text-box">
                                        <p>"We made the right decision to go with Ogling Inches. Right from start to finish it was a great experience. At each stage we were provided with different options. We even changed some designs midway and he accommodated it. inspite of this the project was delivered on time. Post delivery support as well is great.”</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="<?= base_url(); ?>assets/images/testimonial/Jaydev-Sathis.jpg" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                            <h3>Jaydev Sathis</h3>
                                        </div>
                                    ...
                                    <div class="text-box">
                                        <p>“Punctuality, Quality, Responsiveness, Value”.</p>
                                    </div>
                                </div>
                            </div>
                            <!--End Single Testimonial style2 -->
                            ...
                            <div class="single-testimonial-style3">
                                <div class="inner-content">
                                    <div class="client-info">
                                        <div class="image">
                                            <img src="<?= base_url(); ?>assets/images/testimonial/srinivasan-arumugam.jpg" alt="Awesome Image">
                                        </div>
                                        <div class="title">
                                            <h3>srinivasan Arumugam</h3>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        <p>"Prashant” is a professional in every sense of the word. His work is extremely creative, innovative and individualised to reflect each client’s personal style. Ogling Inches can transform a dull space into a stunning one in little time. Prashant is honest and hardworking. I love the plants that he places inside home for interior design, as it provides very fresh air and very useful if your house is in dusty location. Overall an awesome experience!!”.</p>
                                    </div>
                                </div>
                            </div>
                            <!--End Single Testimonial style2 -->
                        ...
                        <div class="single-footer-widget marbtm50">
                            <div class="contact-info-box">
                                <div class="footer-logo" style="padding-bottom: 14px;">
                                    <a href="<?= base_url(); ?>">
                                        <img src="<?= base_url(); ?>assets/images/footer/footer-logo.png" alt="Oglinginches Logo" style="width: 32%;">
                                    </a>
                                </div>
                                <ul>
                                    <li>
