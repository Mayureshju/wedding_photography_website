...
<head>
    <meta charset="UTF-8">
    <title><?= $details_commercial[0]['MP_Name']; ?> | Commercial</title>
    ...
    <?php 
        $MP_Desc = strip_tags($details_commercial[0]['MP_Desc']);
    ?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="single-post-info-content text-center">
                    <h1 class="blog-title"><?= $details_commercial[0]['MP_Name']; ?></h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="blog-single-image-with-text-box">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        <?php
                                        $mpid = $details_commercial[0]['MP_Id'];
                                    ...
                                    <div class="text-box text-justify">
                                        <?= $details_commercial[0]['MP_Desc']; ?>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <p style="font-size: 20px;line-height: 1.8;">
                                        Year: <?= $details_commercial[0]['pYear']; ?></p>
                                    <p style="font-size: 20px;line-height: 1.8;">
                                        Budget: <?= $details_commercial[0]['pBudget']; ?></p>
                                    <p style="font-size: 20px;line-height: 1.8;">
                                        Configuration – <?= $details_commercial[0]['pConfiguration']; ?></p>
